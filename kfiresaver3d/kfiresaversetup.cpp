 ...
 */
KFireSaverSetup::KFireSaverSetup( QWidget* parent,  const char* name, bool modal, Qt::WFlags fl )
    : QDialog( parent, name, modal, fl )
{
    ...
    Q3WhatsThis::add( applyButton, tr2i18n( "quit whithout apply changes" ) );
    ...
    Q3WhatsThis::add( PushButton4, tr2i18n( "save changes and quit" ) );
    ...
    Q3WhatsThis::add( PushButton5, tr2i18n( "quit whithout apply changes" ) );
...
" <me@davidsansome.com>" ) );
    ...
    PreviewKFSFrame = new Q3Frame( tab, "PreviewKFSFrame" );
    ...
    PreviewKFSFrame->setFrameShape( Q3Frame::StyledPanel );
    PreviewKFSFrame->setFrameShadow( Q3Frame::Sunken );
    QToolTip::add( PreviewKFSFrame, tr2i18n( "preview window" ) );
    Q3WhatsThis::add( PreviewKFSFrame, tr2i18n( "Here come the preview (if isn't detached)" ) );
    ...
    previewLabel->setAlignment( int( Qt::AlignCenter ) );
    ...
    Q3WhatsThis::add( detachButton, tr2i18n( "Change the size of the preview window detaching or attaching it to the main window" ) );
    ...
    Q3WhatsThis::add( updateButton, tr2i18n( "apply current changes to the running fireworks scene" ) );
    ...
    Q3WhatsThis::add( showTypeList, tr2i18n( "You can change the flow of events. Randm is the default *old* mode, but we know that we can do better than that!!" ) );
    ...
    Layout3 = new Q3HBoxLayout( privateLayoutWidget, 0, 6, "Layout3"); 
    ...
    Q3WhatsThis::add( neverLabel2, tr2i18n( "mmm.. what about a fireworks screensaver whithout fireworks??" ) );
    ...
    fireworkFrequencySlider->setOrientation( Qt::Horizontal );
    QToolTip::add( fireworkFrequencySlider, tr2i18n( "this sets how often fireworks are released" ) );
    Q3WhatsThis::add( fireworkFrequencySlider, tr2i18n( "this sets how often fireworks are released" ) );
    ...
    Q3WhatsThis::add( oftenLabel2, tr2i18n( "if you have enough power you can try this" ) );
    ...
    Q3WhatsThis::add( trailsBox, tr2i18n( "not yet ported" ) );

    Frame4 = new Q3Frame( tab_3, "Frame4" );
    ...
    Q3WhatsThis::add( allowSparkle, tr2i18n( "This disables the 'flickering' effect of some fireworks. This is useful for example for cascade fireworks" ) );
    ...
    Q3WhatsThis::add( allowCombos, tr2i18n( "This allow a random creation of fireworks that explodes in 2 colors" ) );
    ...
    Q3WhatsThis::add( flashesBox, tr2i18n( "When a fireworks explodes up in the sky, the explosion light everything up for some hundreds of second." ) );
    ...
    Q3WhatsThis::add( bottomFireBox, tr2i18n( "This enables coloured particles jumping on the bottom of the screen. Can be set to look like a burning fire." ) );
    ...
    Q3WhatsThis::add( bottomFireColourList, tr2i18n( "Blue, Orange, Purple, Red... many choices here!!" ) );
    TabWidget2->insertTab( tab_3, tr2i18n( "Particles" ) );

    tab_4 = new QWidget( TabWidget2, "tab_4" );

    logosGroup = new Q3GroupBox( tab_4, "logosGroup" );
    ...
    Q3WhatsThis::add( reduceLogoBox, tr2i18n( "This reduces tp 1/4 the amount of generated logo particles." ) );
    ...
    Layout7 = new Q3HBoxLayout( privateLayoutWidget_2, 0, 6, "Layout7"); 
    ...
    logosFrequencySlider->setOrientation( Qt::Horizontal );
    ...
    Q3WhatsThis::add( tuxBox, tr2i18n( "This enables the Random generation of Tux logos" ) );
    ...
    Q3WhatsThis::add( kdeBox, tr2i18n( "This enables the Random generation of Kde logos" ) );
    ...
    Q3WhatsThis::add( soundBox, tr2i18n( "This enables the sound. For now isn't well implemented." ) );

    starsGroup = new Q3GroupBox( tab_4, "starsGroup" );
    ...
    Q3WhatsThis::add( starsGradientBox, tr2i18n( "Gives lower stars a reddish tint." ) );
    ...
    Q3WhatsThis::add( starsFlickerBox, tr2i18n( "This option produces a sort of vibration in the lightness of the star." ) );
    ...
    Q3WhatsThis::add( starsBox, tr2i18n( "Enable small stars. Can also be set flickering, number of stars and gradient coloring." ) );
    ...
    starNumberSlider->setOrientation( Qt::Horizontal );
    ...
    Q3WhatsThis::add( realtimeBox, tr2i18n( "A new feature.. if fps drops skip frames and render in real-time." ) );
    TabWidget2->insertTab( tab_4, tr2i18n( "Specials" ) );

    tab_5 = new QWidget( TabWidget2, "tab_5" );

    fadeTable = new Q3GroupBox( tab_5, "fadeTable" );
    ...
    Layout7_2_2 = new Q3HBoxLayout( privateLayoutWidget_3, 0, 6, "Layout7_2_2"); 
    ...
    fadingSlider->setOrientation( Qt::Horizontal );
    QToolTip::add( fadingSlider, tr2i18n( "adjust fading value" ) );
    Q3WhatsThis::add( fadingSlider, tr2i18n( "slide to left to reduce 'tail' effect.. to the right you increase it." ) );
    ...
    Q3WhatsThis::add( fadeBox, tr2i18n( "This changes the way the screen is cleared. If this option is enabled, instead of flooding the buffer whith black color, a semi transparent black 'glass' is superposed on scene. This 'fades down' the lightness of the picture and gives a natural 'tail' effect .. try me :-) !!" ) );

    QWidget* privateLayoutWidget_4 = new QWidget( tab_5, "Layout11" );
    privateLayoutWidget_4->setGeometry( QRect( 210, 100, 190, 20 ) ); 
    Layout11 = new Q3HBoxLayout( privateLayoutWidget_4, 0, 6, "Layout11"); 
    ...
    flaresSlider->setOrientation( Qt::Horizontal );
    ...
    Q3WhatsThis::add( flaresBox, tr2i18n( "Multiplies the scale factor for particles near you, resulting in a colorful experience." ) );
    ...
    Q3WhatsThis::add( sphLightBox, tr2i18n( "Multiplies the scale factor for particles near you, resulting in a colorful experience." ) );
